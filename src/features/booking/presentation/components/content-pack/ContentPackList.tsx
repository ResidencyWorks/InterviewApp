...
import { contentPackActivation } from "@/features/booking/application/content-pack/ContentPackActivation";

export function ContentPackList(): React.ReactElement {
	...
	async function handleActivate(): Promise<void> {
		try {
			...
			setStatus(null);
			setError(err instanceof Error ? err.message : "Invalid content pack");
		}
	}
