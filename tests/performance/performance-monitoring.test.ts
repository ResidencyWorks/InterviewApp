...
describe('Performance Monitoring System', () => {
  ...
  describe('Performance Targets', () => {
    it('should have all required performance targets defined', () => {
      ...
      for (const target of requiredTargets) {
        ...
        expect(PERFORMANCE_TARGETS[target].criticalThreshold).toBeGreaterThan(0)
      }
    })
  ...
  describe('Performance Monitoring Integration', () => {
    it('should track multiple operations and provide aggregate stats', async () => {
      ...
      const operations = [
        { name: 'api.evaluate', duration: 200 },
        { name: 'api.evaluate', duration: 180 },
        { name: 'redis.lookup', duration: 30 },
        { name: 'redis.lookup', duration: 45 },
        { name: 'content.validation', duration: 800 },
      ]
